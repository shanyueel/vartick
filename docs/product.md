...
- Native mobile apps
- Recurring routine templates _(see risk R3 in [roadmap.md](./roadmap.md#risk-register) — the most likely scope creep vector)_
- Historical trend analysis beyond a 7-day window
- Energy-based scheduling insights — peak-window detection, energy heatmaps, energy-aware block suggestions _(capture only in v1; see [Theory Foundation](#theory-foundation--how-principles-become-features))_
